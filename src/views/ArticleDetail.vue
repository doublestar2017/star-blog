<template>
  <div style="width: 100%">
    <div class="article clearfix">
      ...
      >
        <div class="header">
          <h1 class="title">qqqq{{state.articleDetail.title}}</h1>
          <div class="author">
            <div class="avatar">
              <img
                class="auth-logo"
            ...
            <div class="info">
              <span class="name">
                <span>xx{{state.articleDetail.author}}</span>
              </span>
              <div
              ...
              <div class="meta">
                <span class="publish-time">
                  2020{{state.articleDetail.create_time? formatTime(state.articleDetail.create_time): ''}}
                </span>
                <span class="wordage">
                  字数1 {{state.articleDetail.numbers}}
                </span>
                <span class="views-count">
                  阅读1 {{state.articleDetail.meta.views}}
                </span>
